...
#define _DUTY_MIN 551 // servo full clockwise position (0 degree)
...
// get a distance reading from the USS
  ...
  dist_ema = dist_ema*(100-alpha)/100 + dist_raw*alpha/100;
...
// adjust servo position according to the USS read value
  ...
  // add your code here!
  myservo.writeMicroseconds(map(dist_ema, dist_min, dist_max, _DUTY_MIN, _DUTY_MAX));
